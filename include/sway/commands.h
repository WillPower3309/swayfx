...
sway_cmd cmd_titlebar_align;
sway_cmd cmd_titlebar_border_thickness;
sway_cmd cmd_titlebar_gaps;
sway_cmd cmd_titlebar_margin;
sway_cmd cmd_titlebar_padding;
sway_cmd cmd_titlebar_separator;
sway_cmd cmd_titlebar_tab_arrangement;
sway_cmd cmd_titlebar_width;
sway_cmd cmd_titlebar_blur;
